...
},{"./src/css/main.scss":10,"./src/js/AudioPlayer.js":14,"./src/js/Microphone":17,"./src/js/MidiViewer.js":18,"./src/js/PitchDetection.js":19,"./src/js/UserInterface.js":23,"./src/js/Utils.js":24}],2:[function(require,module,exports){
'use strict'
...
},{"cssify":5}],9:[function(require,module,exports){
...
module.exports = require('sassify')('html, body {   height: 100%; }  body {   margin: 0px;   padding: 0px;   background-color: #e0dfdc;   background: #bfbfbf;   background: radial-gradient(circle, rgba(191, 191, 191, 0) 0%, rgba(224, 223, 220, 0) 50%, #bfbfbf 100%); }  #score {   position: fixed; } ');;
},{"sassify":8}],11:[function(require,module,exports){
module.exports = require('sassify')('@keyframes spin {   from {     transform: rotate(0deg);     border: 0.2rem solid rgba(255, 255, 255, 0.4); }   50% {     border: 0.2rem solid rgba(237, 106, 95, 0.4); }   to {     transform: rotate(360deg);     border: 0.2rem solid rgba(255, 255, 255, 0.4); } }  * {   box-sizing: border-box; }  #microphone {   position: absolute;   width: 100%;   height: 100%;   display: flex;   align-items: center;   justify-content: center;   pointer-events: none; }  .button {   pointer-events: all;   transition: background 0.4s ease-in-out, color 0.4s ease-in-out;   position: relative;   display: inline-block;   width: 6rem;   height: 6rem;   margin: 0 0;   padding: 0;   background: #ffffff;   border-radius: 50%;   border: none;   outline: none;   font-size: 4rem;   cursor: pointer; }   .button.record::before {     animation: spin 1s linear infinite;     transition: opacity 0.4s ease-in-out;     content: "";     position: absolute;     top: 0;     left: 0;     width: 5.6rem;     height: 5.6rem;     background: transparent;     opacity: 0;     border-radius: 50%;     border: 0.2rem solid rgba(255, 255, 255, 0.4); }   .button.record.button--active {     background: #ed6a5f;     color: #ffffff; }     .button.record.button--active::before {       opacity: 1; }   .button.disabled {     opacity: 0.2;     pointer-events: none;     cursor: not-allowed; }   .button span {     font-size: 4rem;     color: #383330; } ');;
},{"sassify":8}],12:[function(require,module,exports){
module.exports = require('sassify')('#interface {   width: 100%;   height: 50%;   position: absolute;   top: 0px; }  #interface {   display: flex;   justify-content: center;   overflow: hidden;   margin: 0;   background: url(https://i.imgur.com/vRXJ21l.png), radial-gradient(#c2b490, #97886b);   /*radial-gradient(#3a3b3f, #313236);*/ }  section {   align-self: center;   width: 15em;   height: 2em;   transform: rotate(-90deg);   background: linear-gradient(-90deg, #c2b490 1px, #97886b 1px, #5f5a4f 2px, transparent 2px) 7.5625em 0;   background-size: 1em 1px;   font: 1em/2 verdana, sans-serif;   text-align: center; }   section label {     position: absolute;     transform-origin: center center;     transform: rotate(90deg) translateY(11em);     color: #5f5a4f; }   section:nth-of-type(1) {     height: 2em; }     section:nth-of-type(1) label {       position: absolute;       transform: rotate(90deg) translateY(12.5em); }   section:nth-of-type(2) {     position: relative;     height: 2em; }     section:nth-of-type(2) label {       position: absolute;       transform: rotate(90deg) translateY(12.5em); }     section:nth-of-type(2):before {       position: absolute;       bottom: 100%;       left: 50%;       width: 3em;       transform: translate(-50%, 50%) rotate(90deg) translate(-70%);       color: #676672;       font-size: 0.8em;       font-weight: 600;       line-height: 8.75;       text-align: right;       text-indent: -0.25em;       text-shadow: 0 -1px #000; }     section:nth-of-type(2) input[type="range"]:nth-of-type(1) /deep/ #track:before {       content: "32"; }     section:nth-of-type(2) input[type="range"]:nth-of-type(2) /deep/ #track:before {       content: "64"; }     section:nth-of-type(2) input[type="range"]:nth-of-type(3) /deep/ #track:before {       content: "125"; }     section:nth-of-type(2) input[type="range"]:nth-of-type(4) /deep/ #track:before {       content: "250"; }     section:nth-of-type(2) input[type="range"]:nth-of-type(5) /deep/ #track:before {       content: "500"; }     section:nth-of-type(2) input[type="range"]:nth-of-type(6) /deep/ #track:before {       content: "1k"; }     section:nth-of-type(2) input[type="range"]:nth-of-type(7) /deep/ #track:before {       content: "2k"; }     section:nth-of-type(2) input[type="range"]:nth-of-type(8) /deep/ #track:before {       content: "4k"; }     section:nth-of-type(2) input[type="range"]:nth-of-type(9) /deep/ #track:before {       content: "8k"; }     section:nth-of-type(2) input[type="range"]:nth-of-type(10) /deep/ #track:before {       content: "16k"; }  input[type="range"] {   display: block;   margin: 0 auto;   border: none;   padding: 0;   width: 14.5em;   height: 2em;   background: transparent;   font: inherit;   cursor: pointer;   /* slider components */ }   input[type="range"], input[type="range"]::-webkit-slider-runnable-track, input[type="range"]::-webkit-slider-thumb {     -webkit-appearance: none; }   input[type="range"]::-webkit-slider-runnable-track {     border: none;     height: 1em;     border-radius: 0.5em;     box-shadow: inset -0.125em 0.125em 0.125em #1c1c1c, inset 1px -1px 1px #4a4a4a;     background: #383330; }   input[type="range"]::-moz-range-track {     border: none;     height: 1em;     border-radius: 0.5em;     box-shadow: inset -0.125em 0.125em 0.125em #1c1c1c, inset 1px -1px 1px #4a4a4a;     background: #383330; }   input[type="range"]::-ms-track {     border: none;     height: 1em;     border-radius: 0.5em;     box-shadow: inset -0.125em 0.125em 0.125em #1c1c1c, inset 1px -1px 1px #4a4a4a;     background: #383330;     color: transparent; }   input[type="range"]::-ms-fill-lower, input[type="range"]::-ms-fill-upper, input[type="range"]::-ms-tooltip {     display: none; }   input[type="range"]::-webkit-slider-thumb {     margin-top: -0.25em;     border: none;     width: 1.5em;     height: 1.5em;     border-radius: 50%;     background: radial-gradient(at 80% 50%, #777, rgba(119, 119, 119, 0) 70%) no-repeat 100% 50%, radial-gradient(at 50% 50%, #777, rgba(119, 119, 119, 0) 70%) no-repeat -65% 90%, radial-gradient(rgba(255, 255, 255, 0) 32%, #fff 35%), linear-gradient(90deg, #838383, #292828) no-repeat 50% 50%;     /*linear-gradient(90deg, #f0984d, #bf7145) no-repeat 50% 50%;*/     background-size: 35% 65%, 65% 65%, 100% 100%, 65% 65%; }   input[type="range"]::-moz-range-thumb {     border: none;     width: 1.5em;     height: 1.5em;     border-radius: 50%;     background: radial-gradient(at 80% 50%, #777, rgba(119, 119, 119, 0) 70%) no-repeat 100% 50%, radial-gradient(at 50% 50%, #777, rgba(119, 119, 119, 0) 70%) no-repeat -65% 90%, radial-gradient(rgba(255, 255, 255, 0) 32%, #fff 35%), linear-gradient(90deg, #838383, #292828) no-repeat 50% 50%;     /*linear-gradient(90deg, #f0984d, #bf7145) no-repeat 50% 50%;*/     background-size: 35% 65%, 65% 65%, 100% 100%, 65% 65%; }   input[type="range"]::-ms-thumb {     border: none;     width: 1.5em;     height: 1.5em;     border-radius: 50%;     background: radial-gradient(at 80% 50%, #777, rgba(119, 119, 119, 0) 70%) no-repeat 100% 50%, radial-gradient(at 50% 50%, #777, rgba(119, 119, 119, 0) 70%) no-repeat -65% 90%, radial-gradient(rgba(255, 255, 255, 0) 32%, #fff 35%), linear-gradient(90deg, #838383, #292828) no-repeat 50% 50%;     /*linear-gradient(90deg, #f0984d, #bf7145) no-repeat 50% 50%;*/     background-size: 35% 65%, 65% 65%, 100% 100%, 65% 65%; }   input[type="range"] /deep/ #track {     position: relative; }     input[type="range"] /deep/ #track:before {       position: absolute;       top: -0.5em;       right: 100%;       transform: translate(50%) rotate(90deg) translate(0, 50%) scale(0.8);       color: #676672;       font-weight: 900;       text-shadow: 0 -1px #000;       white-space: nowrap;       font: 1em/2 verdana, sans-serif; }   input[type="range"]:focus {     outline: none;     background-color: rgba(0, 0, 0, 0.1); } ');;
},{"sassify":8}],13:[function(require,module,exports){
module.exports = require('sassify')('#viewer {   position: absolute;   display: flex;   justify-content: center;   align-items: center;   top: 50%;   width: 100%;   height: 50%;   background: url(https://i.imgur.com/vRXJ21l.png), radial-gradient(#c2b490, #97886b);   /* radial-gradient(#3a3b3f, #313236);*/ }  #viewer.hide {   display: none; }  #viewer:before {   position: absolute;   left: 0;   right: 0;   color: white;   font: 400 1.5em/2 "Google Sans", sans-serif;   text-align: center;   content: attr(data-text); }  canvas {   background: rgba(0, 0, 0, 0.1);   border-radius: 8px;   box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.1); } ');;
},{"sassify":8}],14:[function(require,module,exports){
...
},{"./EventEmitter.js":15,"./Utils.js":24,"midi-player-js/build":7,"tone":9}],15:[function(require,module,exports){
class EventEmitter {
  constructor() {
    this._events = {};
  }
...
},{"../css/microphone.scss":11,"./EventEmitter.js":15}],18:[function(require,module,exports){
...
},{"../css/viewer.scss":13,"./FrequencyMatcher.js":16,"./PitchPointer.js":20,"./Playhead.js":21,"./Utils.js":24}],19:[function(require,module,exports){
const EventEmitter = require("./EventEmitter.js");
const Utils = require("./Utils.js");
...
},{"./EventEmitter.js":15,"./Utils.js":24}],20:[function(require,module,exports){
class PitchPointer {
  constructor(ctx) {
    this.ctx = ctx;
  }
...
},{"./EventEmitter.js":15}],23:[function(require,module,exports){
...
},{"../css/style.scss":12,"./EventEmitter.js":15,"./Slider":22}],24:[function(require,module,exports){
class Utils {
